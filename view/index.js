...
class View {
  ...
  static help() {
    ...
    console.log('$ node index.js contacts:update <id> <column:value-valuecont.>,<column2:value2-valuecont.>');
    ...
    console.log('$ node index.js addresses:update <id> <column:value-valuecont.>,<column2:value2-valuecont.>');
